    ...
    <div className='container-n1'>
      ...
      <div id='v1'>
        ...
        <p>Viivakaavio globaaleista pintalämpötilan vaihteluista kattaen 170 vuoden ajanjakson sekä <br/>
          ...
          Bolin Centren<a
            href="https://www.ncei.noaa.gov/pub/data/paleo/contributions_by_author/moberg2005/nhtemp-moberg2005.txt"> data.</a>
          <br/>
      ...
      <div id='v3'>
        ...
        <p>Viivakaavio ilmakehän CO<sub>2</sub>-pitoisuuksista sekä historian merkittävistä tapahtumista kattaen 1000
          vuoden ajanjakson, <br/>
      ...
      <div id='v6'>
        ...
        <p>Viivagraafi ilmakehän CO<sub>2</sub>-pitoisuuksista kattaen 800 000 vuoden ajanjakson, <br/>
          ...
          Tutkimuksen<a
            href="https://www.ncei.noaa.gov/pub/data/paleo/icecore/antarctica/antarctica2015co2composite.tx"> kuvaus.</a>
        </p>
        <V6/>
      </div>
      ...
      <div id='v7'>
        ...
        <p>Moniakselinen viivagraafi arvioiduista lämpötilan muutoksista ja CO<sub>2</sub>-pitoisuuksista sekä historian
          merkittävistä <br/>
          tapahtumista kattaen 2 miljoonan vuoden ajanjakson, perustuen lukuisten tutkimusten ja mittaustulosten
          yhdistämiseen sekä keskiarvoistamiseen. <br/>
          C. Snyderin tutkimuksen<a href="http://carolynsnyder.com/papers/Snyder_Data_Figures.zip "> data.</a> <br/>
          C. Snyderin tutkimuksen<a
            href="https://climate.fas.harvard.edu/files/climate/files/snyder_2016.pdf"> kuvaus.</a> <br/>
          South Hamptonin yliopiston<a href="https://www.southampton.ac.uk/~cpd/history.html"> data.</a> <br/>
        </p>
        <V7/>
      </div>
