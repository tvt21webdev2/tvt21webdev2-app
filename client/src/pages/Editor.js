...
export default function Editor() {
  ...
  const [chartDescs, setChartDescs] = useState({v1Desc: null, v3Desc: null, v5Desc: null, v6Desc: null, v7Desc: null, v8Desc: null, v9Desc: null})
        ...
        <Grid item xs={5}>
          <Card id="chart-card" sx={{ minWidth: {sm: 575, md: 875}, minHeight: 450 }} raised={charts.v1} >
            <CardActionArea onClick={() => setCharts({...charts, v1: charts.v1 ? false : true})}>
              <CardHeader sx={{height: 150}} title="Globaalit pintalämpötilavaihteluilmiöt tammikuusta 1850 lähtien sekä pohjoisen pallonpuoliskon lämpötilat 2000 vuodelta." />
        ...
        <Grid item xs={5}>
          <Card id="chart-card" sx={{ minWidth: {sm: 575, md: 875}, minHeight: 450 }} raised={charts.v3}>
            <CardActionArea onClick={() => setCharts({...charts, v3: charts.v3 ? false : true})}>
              <CardHeader sx={{height: 150}} title="Ilmakehän hiilidioksidipitoisuudet Mauna Loaalta alkaen vuodesta 1958 sekä antarktiset jäämittaukset ilmakehän hiilidioksidipitoisuuksista." />
        ...
        {/* <Grid item xs={5}>
          <Card id="chart-card" sx={{ minWidth: {sm: 575, md: 875}, minHeight: 450 }} raised={charts.v4} >
            <CardActionArea onClick={() => setCharts({...charts, v4: charts.v4 ? false : true})}>
              <CardHeader sx={{height: 150}} title="Antarktiset jäämittaukset ilmakehän hiilidioksidipitoisuuksista yhdistettynä Mauna Loan mittauksiin." />
        ...
        <Grid item xs={5}>
          <Card id="chart-card" sx={{ minWidth: {sm: 575, md: 875}, minHeight: 450 }} raised={charts.v5} >
            <CardActionArea onClick={() => setCharts({...charts, v5: charts.v5 ? false : true})}>
              <CardHeader sx={{height: 150}} title="Vostokin jäämittaukset hiilidioksidipitoisuuksista vuosilta 417160 - 2342 BP" />
        ...
        <Grid item xs={5}>
          <Card id="chart-card" sx={{ minWidth: {sm: 575, md: 875}, minHeight: 450 }} raised={charts.v6} >
            <CardActionArea onClick={() => setCharts({...charts, v6: charts.v6 ? false : true})}>
              <CardHeader sx={{height: 150}} title="Jäämittaukset 800k vuodelta yhdistettynä hiilidioksidimittauksiin." />
        ...
        <Grid item xs={5}>
          <Card id="chart-card" sx={{ minWidth: {sm: 575, md: 875}, minHeight: 450 }} raised={charts.v7} >
            <CardActionArea onClick={() => setCharts({...charts, v7: charts.v7 ? false : true})}>
              <CardHeader sx={{height: 150}} title="Globaalin lämpötilan evoluutio viimeisen kahden miljoonan vuoden aikana." />
